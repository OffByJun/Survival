...
namespace AstraNope.Gameplay.Player
{
    public class CameraController : MonoBehaviour
    {
        ...
        private void Locker(PlayerUIStateMessage msg)
        {
            switch (msg.state)
            {
        ...
        private void Constructor(
            ISubscriber<PlayerUIStateMessage> iPlayerUIStateSub,
            ISubscriber<VehicleControlAssignedMessage> vehicleControlSub,
