...
namespace AstraNope.Mechanics.Survival
{
    public class PlayerStatSimulator
    {
        private readonly PlayerStat _stat;
        private readonly IPublisher<PlayerStatMessage> _publisher;
        private float _lastRun;

        public PlayerStatSimulator(PlayerStat stat, IPublisher<PlayerStatMessage> publisher)
        {
            _stat = stat;
