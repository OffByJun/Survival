...
using AstraNope.Mechanics.Movement;
...
namespace AstraNope.Mechanics.Player
{
    ...
    public class MovementController : MonoBehaviour
    {
        ...
        private void UIState(PlayerUIStateMessage msg)
        {
            switch (msg.state)
            {
        ...
        private void OnVehicleControlAssigned(VehicleControlAssignedMessage msg)
        {
        ...
        private void OnVehicleStateChanged(PlayerVehicleStateMessage msg)
        {
        ...
        public void Constructor(IPublisher<PlayerMovementMessage> movementPublisher,
            ...
            ISubscriber<PlayerUIStateMessage> playerUIStateSubscriber,
            ISubscriber<PlayerVehicleStateMessage> vehicleStateSubscriber,
            ISubscriber<VehicleControlAssignedMessage> vehicleControlSubscriber,
