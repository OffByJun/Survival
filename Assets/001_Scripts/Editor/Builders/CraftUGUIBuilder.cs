...
{
    [InitializeOnLoad]
    internal static class CraftUGUIBuilder
    {
        ...
        static CraftUGUIBuilder() => EditorApplication.delayCall += RebuildIfNeeded;
        ...
        private static void Build(CraftPanel panel, bool saveScene)
        {
            ...
            if (inventoryPanel) UIInputBindingEditor.EnsureNavigationForPanels(inventoryPanel, panel);
