...
{
    internal static class UIInputBindingEditor
    {
        ...
        private static void Apply(bool saveScene)
        {
            ...
            UIRoundedStyle.ApplyToRoot(inventory.gameObject);
            UIRoundedStyle.ApplyToRoot(craft.gameObject);
            ...
            Vector2 offsetMin, Vector2 offsetMax, bool active)
        {
            var go = new GameObject(name, typeof(RectTransform), typeof(CanvasRenderer), typeof(Image),
                typeof(Button), typeof(UIInteractableFX));
            go.layer = 5;
